...
There might be an extra package that you might have to download a package called Rtools. website is https://cran.r-project.org/bin/windows/Rtools/ its very easy to follow along.  